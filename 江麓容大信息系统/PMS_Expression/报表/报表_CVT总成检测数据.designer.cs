...
namespace Expression
{
    partial class 报表_CVT总成检测数据
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Expression.报表.CVT下线试验数据.rdlc";
            ...
            this.Name = "报表_CVT总成检测数据";
            this.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Show;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "报表_CVT总成检测数据";
            this.Load += new System.EventHandler(this.报表_CVT总成检测数据_Load);
        ...
        private Expression.报表.DepotManagementDataSet DepotManagementDataSet;
    }
}