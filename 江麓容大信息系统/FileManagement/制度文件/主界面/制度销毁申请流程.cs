...
{
    public partial class 制度销毁申请流程 : Form
    {
        /// <summary>
        /// 制度流程服务组件
        /// </summary>
        ...
        public 制度销毁申请流程()
        {
            ...
            m_billNoControl = new BillNumberControl(CE_BillTypeEnum.制度销毁申请流程.ToString(), m_serverInstitution);
            m_billMessageServer.BillType = CE_BillTypeEnum.制度销毁申请流程.ToString();
        }
        ...
        protected override void DefWndProc(ref Message m)
        {
            switch (m.Msg)
            {
                ...
                case WndMsgSender.PositioningMsg:
                    ...
                    DataTable dtMessage = UniversalFunction.PositioningOneRecord(msg.MessageContent, CE_BillTypeEnum.制度销毁申请流程.ToString());
        ...
        void RefreshData()
        {
            ...
            dataGridView1.DataSource =
                UniversalControlLibrary.BillInfo.BillInfoShowFilter(m_serverInstitution.GetAllBill(CE_BillTypeEnum.制度销毁申请流程), "流程编号");

            dataGridView1.Columns["总经理"].Visible = false;
            dataGridView1.Columns["总经理审查日期"].Visible = false;
        ...
        {
            制度销毁申请流程明细 frmDetail = new 制度销毁申请流程明细();
            frmDetail.Custom_FlowInfo = m_serverInstitution.GetProcessInfo(null);
            FormCommonProcess frm = new FormCommonProcess(CE_BillTypeEnum.制度销毁申请流程, null, frmDetail, CE_OperatorMode.添加);
        ...
        bool frm_CommonProcessSubmit(CustomFlowForm form, string advise)
        {
            ...
            if (!m_serverInstitution.AddInfo(lnqProcess, null, out m_strErr))
            {
        ...
        private void 制度销毁申请流程_Load(object sender, EventArgs e)
        {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            FormCommonProcess frm = new FormCommonProcess(CE_BillTypeEnum.制度销毁申请流程, null, frmDetail, CE_OperatorMode.编辑);
