...
{
    public partial class 制度修订废弃申请流程 : Form
    {
        /// <summary>
        /// 制度流程服务组件
        /// </summary>
        ...
        protected override void DefWndProc(ref Message m)
        {
            switch (m.Msg)
            {
                ...
                case WndMsgSender.PositioningMsg:
                    ...
                    DataTable dtMessage = UniversalFunction.PositioningOneRecord(msg.MessageContent, CE_BillTypeEnum.制度修订废弃申请流程.ToString());
        ...
        void RefreshData()
        {
            ...
            dataGridView1.DataSource =
                UniversalControlLibrary.BillInfo.BillInfoShowFilter(m_serverInstitution.GetAllBill(CE_BillTypeEnum.制度修订废弃申请流程), "流程编号");
        ...
        {
            制度修订废弃申请流程明细 frmDetail = new 制度修订废弃申请流程明细();
            frmDetail.Custom_FlowInfo = m_serverInstitution.GetProcessInfo(null);
            FormCommonProcess frm = new FormCommonProcess(CE_BillTypeEnum.制度修订废弃申请流程, null, frmDetail, CE_OperatorMode.添加);
        ...
        private void 制度修订废弃申请流程_Load(object sender, EventArgs e)
        {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            FormCommonProcess frm = new FormCommonProcess(CE_BillTypeEnum.制度修订废弃申请流程, null, frmDetail, CE_OperatorMode.编辑);
