...
{
    public partial class 制度类别 : Form
    {
        /// <summary>
        /// 权限标志
        /// </summary>
        ...
        public 制度类别(PlatformManagement.FunctionTreeNodeInfo nodeInfo)
        {
            InitializeComponent();
        ...
        {
            ClearInfo();
            dataGridView1.DataSource = m_serviceSystemFileSort.GetAllInfo(CE_FileType.制度文件);
        }
        ...
        void GetInfo()
        {
            ...
            m_lnqFileSort.FileType = (int)CE_FileType.制度文件;
        }
