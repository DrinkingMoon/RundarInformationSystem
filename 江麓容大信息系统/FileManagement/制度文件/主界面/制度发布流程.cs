...
{
    public partial class 制度发布流程 : Form
    {
        /// <summary>
        /// 制度发布流程服务组件
        /// </summary>
        ...
        protected override void DefWndProc(ref Message m)
        {
            switch (m.Msg)
            {
                ...
                case WndMsgSender.PositioningMsg:
                    ...
                    DataTable dtMessage = UniversalFunction.PositioningOneRecord(msg.MessageContent, CE_BillTypeEnum.制度发布流程.ToString());
        ...
        void RefreshData()
        {
            ...
            dataGridView1.DataSource =
                UniversalControlLibrary.BillInfo.BillInfoShowFilter(m_serverInstitution.GetAllBill(CE_BillTypeEnum.制度发布流程), "流程编号");
        ...
        {
            制度发布流程明细 frmDetail = new 制度发布流程明细();
            frmDetail.Custom_FlowInfo = m_serverInstitution.GetProcessInfo(null);
            FormCommonProcess frm = new FormCommonProcess(CE_BillTypeEnum.制度发布流程, null, frmDetail, CE_OperatorMode.添加);
        ...
        bool CheckData(FM_InstitutionProcess lnqProcess)
        {
            ...
            if (lnqProcess.Department == null || lnqProcess.Department.Trim().Length == 0)
            {
                MessageDialog.ShowPromptMessage("请选择归口部门");
                return false;
            }
        ...
        private void 制度发布流程_Load(object sender, EventArgs e)
        {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            FormCommonProcess frm = new FormCommonProcess(CE_BillTypeEnum.制度发布流程, null, frmDetail, CE_OperatorMode.编辑);
