...
{
    public partial class 文件发布流程 : Form
    {
        /// <summary>
        /// 文件发布流程服务组件
        /// </summary>
        ...
        protected override void DefWndProc(ref Message m)
        {
            switch (m.Msg)
            {
                ...
                case WndMsgSender.PositioningMsg:
                    ...
                    DataTable dtMessage = UniversalFunction.PositioningOneRecord(msg.MessageContent, CE_BillTypeEnum.文件发布流程.ToString());
        ...
        void RefreshData()
        {
            dataGridView1.DataSource = m_serverReleaseProcess.GetAllInfo(checkBillDateAndStatus1.cmbBillStatus.Text,
        ...
        private void 文件发布流程_Load(object sender, EventArgs e)
        {
            RefreshData();

            btnAdd.Visible = BasicInfo.ListRoles.Contains(CE_RoleEnum.体系工程师.ToString());
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageDialog.ShowEnquiryMessage("是否要删除此流程?") == DialogResult.Yes)
            {
                ...
                if (!m_serverReleaseProcess.DeleteProcess(strSDBNo, out m_strErr))
                {
