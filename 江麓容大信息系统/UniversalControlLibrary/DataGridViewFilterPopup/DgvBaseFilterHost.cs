...
namespace UniversalControlLibrary {
    ...
    public class DgvBaseFilterHost : UserControl {
        ...
        private ToolStripDropDownFilter mPopup;
        private CustomDataGridView mDataGridView;
        ...
        /// </summary>
        public ToolStripDropDownFilter Popup
        {
          get { 
              if (mPopup==null) {
                  mPopup = new ToolStripDropDownFilter();
