...
namespace UniversalControlLibrary
{
    ...
    public class DataGridViewNumericUpDownCell : DataGridViewTextBoxCell
    {
                                                    ...
                                                    DataGridViewDataErrorContexts context)
        {
            ...
            if (!GlobalObject.GeneralFunction.IsNullOrEmpty(formattedNumber) && value != null)
            {
        ...
        public override bool KeyEntersEditMode(KeyEventArgs e)
        {
            ...
            if (!GlobalObject.GeneralFunction.IsNullOrEmpty(negativeSignStr) && negativeSignStr.Length == 1)
            {
    ...
    class DataGridViewNumericUpDownEditingControl : NumericUpDown, IDataGridViewEditingControl
    {
        ...
        protected override void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            else
            {
                ...
                string negativeSignStr = numberFormatInfo.NegativeSign;
                if (!GlobalObject.GeneralFunction.IsNullOrEmpty(decimalSeparatorStr) && decimalSeparatorStr.Length == 1)
                {
                    notifyValueChange = decimalSeparatorStr[0] == e.KeyChar;
                }
                if (!notifyValueChange && !GlobalObject.GeneralFunction.IsNullOrEmpty(groupSeparatorStr) && groupSeparatorStr.Length == 1)
                {
                    notifyValueChange = groupSeparatorStr[0] == e.KeyChar;
                }
                if (!notifyValueChange && !GlobalObject.GeneralFunction.IsNullOrEmpty(negativeSignStr) && negativeSignStr.Length == 1)
                {
