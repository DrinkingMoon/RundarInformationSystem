...
namespace Service_Manufacture_Storage
{
    ...
    /// 入库业务申请单服务类
    /// </summary>
    class RequisitionService_OutPut : IRequisitionService_OutPut
    {
        /// <summary>
        /// 获得单条业务总单信息
        /// </summary>
        ...
        public Business_WarehouseOutPut_Requisition GetSingleBillInfo(string billNo)
        {
            if (billNo == null)
            {
                return null;
            ...
            var varData = from a in ctx.Business_WarehouseOutPut_Requisition
        ...
        public List<View_Business_WarehouseOutPut_RequisitionDetail> GetListViewDetailInfo(string billNo)
        {
            if (billNo == null)
            {
                return null;
            ...
            var varData = from a in ctx.View_Business_WarehouseOutPut_RequisitionDetail
                          where a.单据号 == billNo
                          select a;
        ...
        public void SaveInfo(Business_WarehouseOutPut_Requisition billInfo, List<View_Business_WarehouseOutPut_RequisitionDetail> detailInfo)
        {
            DepotManagementDataContext ctx = CommentParameter.DepotDataContext;
            ctx.Connection.Open();
            ...
            try
            {
                ...
                if (varData.Count() == 1)
                {
                    Business_WarehouseOutPut_Requisition lnqBill = varData.Single();
                ...
                {
                    ctx.Business_WarehouseOutPut_Requisition.InsertOnSubmit(billInfo);
                }
                else
                {
                ...
                var varDetail = from a in ctx.Business_WarehouseOutPut_RequisitionDetail
                                where a.BillNo == billInfo.BillNo
                                select a;

                ctx.Business_WarehouseOutPut_RequisitionDetail.DeleteAllOnSubmit(varDetail);
                ctx.SubmitChanges();

                foreach (View_Business_WarehouseOutPut_RequisitionDetail item in detailInfo)
                {
                    Business_WarehouseOutPut_RequisitionDetail lnqDetail = new Business_WarehouseOutPut_RequisitionDetail();
                    ...
                    ctx.Business_WarehouseOutPut_RequisitionDetail.InsertOnSubmit(lnqDetail);
                }
        ...
        public void DeleteInfo(string billNo)
        {
            ...
            try
            {
                ...
                ctx.Business_WarehouseOutPut_Requisition.DeleteAllOnSubmit(varData);
                ctx.SubmitChanges();
        ...
        public List<Business_WarehouseOutPut_Requisition> GetListBillInfo(List<string> listBillNo)
        {
            try
            {
                DepotManagementDataContext ctx = CommentParameter.DepotDataContext;
        ...
        {
            string strSql = "select a.*, b.BillType from View_Business_WarehouseOutPut_RequisitionDetail as a " +
                "inner join Business_WarehouseOutPut_Requisition as b on a.单据号 = b.BillNo where a.单据号 = '" + billNo + "'";
        ...
        //public List<View_Business_WarehouseOutPut_RequisitionDetail> GetListViewDetail_OrderForm(string billNo, List<string> listOrderForm)
        //{
        //    List<View_Business_WarehouseOutPut_RequisitionDetail> listResult =
        //        new List<View_Business_WarehouseOutPut_RequisitionDetail>();
        ...
        //    {
        //        View_Business_WarehouseOutPut_RequisitionDetail tempLnq =
        //            new View_Business_WarehouseOutPut_RequisitionDetail();
