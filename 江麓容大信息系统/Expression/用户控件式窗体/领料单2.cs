...
namespace Expression
{
    ...
    /// 领料单2界面
    /// </summary>
    public partial class 领料单2 : Form
    {
        #region 成员变量
        ...
        public 领料单2(PlatformManagement.FunctionTreeNodeInfo nodeInfo)
        {
            InitializeComponent();
        ...
        private void 领料单2_Load(object sender, EventArgs e)
        {
        ...
        {
            string queryFilter = string.Format(" where 领料单号 = '{0}' ", row.Cells["领料单号"].Value.ToString());
            DataTable dt = GetAllBill(queryFilter);

            if (dt.Rows[0]["编制人编码"].ToString() == BasicInfo.LoginID)
            {
                return true;
            }
            else
        ...
        private void 领料员提交单据ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            RefreshDataGridView(GetAllBill(null));
        ...
        private void 设置领料清单ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                FormFetchGoods2 form = new FormFetchGoods2(FormFetchGoods2.OperateMode.新建, txtBill_ID.Text, txtReliantBillNo.Text);
        ...
        private void 查看领料清单ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FormFetchGoods2 form = new FormFetchGoods2(FormFetchGoods2.OperateMode.查看, txtBill_ID.Text, txtReliantBillNo.Text);
            form.m_strFlag = lblBillStatus.Text;
            form.ShowDialog();
        }
        ...
        private void 审核ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            List<string> lstRoleName = 
                m_billMessageServer.GetSuperior(CE_RoleStyleType.上级领导, dataGridView1.SelectedRows[0].Cells["编制人编码"].Value.ToString());
        ...
        private void 核实领料清单ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FormFetchGoods2 form = new FormFetchGoods2(FormFetchGoods2.OperateMode.仓库核实, 
        ...
        private void 确认出库ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable dt = m_billServer.CheckGoodsVersion(dataGridView1.CurrentRow.Cells["领料单2号"].Value.ToString());

                if (MessageDialog.ShowEnquiryMessage("此整台份领料单2中的物品的版次号与BOM表中的规定的版次号不符，是否需要导出EXCEL？")
                    == DialogResult.Yes)
                {
        ...
        private DataTable GetAllBill(string queryResultFilter)
        {
            string sql = "select * from DepotManagement.dbo.View_S_MaterialRequisition_Temp ";

            sql += "Where " + m_billServer.QueryResultFilter;

            if (!GlobalObject.GeneralFunction.IsNullOrEmpty(queryResultFilter))
            {
                sql += "AND " + queryResultFilter;
            }
        ...
        private void menuItemReresh_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataTable dt = GetAllBill(m_billServer.QueryResultFilter);
        ...
        private void 领料单2_Resize(object sender, EventArgs e)
        {
        ...
        /// <param name="e"></param>
        private void 打印领料单2物品条形码ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (!CheckSelectedRow())
            {
                return;
            ...
            FormFetchGoods2 form = new FormFetchGoods2(FormFetchGoods2.OperateMode.打印条形码, billNo, "");
            form.m_strFlag = lblBillStatus.Text;
            form.ShowDialog();
        }
        ...
        private void dataGridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            //{
            //    if (dgvr.Cells["关联单据"].Value.ToString() == BillTypeEnum.领料单2.ToString()
            //        && dgvr.Cells["单据状态"].Value.ToString() != MaterialRequisitionBillStatus.已出库.ToString())
            //    {
            //        dgvr.DefaultCellStyle.BackColor = Color.LightBlue;

            //        IEnumerable<View_S_MaterialRequisitionGoods> listGoodsInfo = m_goodsServer.GetGoods(dgvr.Cells["领料单2号"].Value.ToString());
