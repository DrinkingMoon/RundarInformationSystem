...
namespace Expression
{
    ...
    /// 营销退货单界面
    /// </summary>
    public partial class 营销退货单 : Form
    {
        /// <summary>
        /// 单据编号控制类
        /// </summary>
        ...
        private void 营销退货_Load(object sender, EventArgs e)
        {
        ...
        {
            营销退货明细单 form = new 营销退货明细单(0, m_authFlag);
            form.ShowDialog();
        ...
        private void ShowForm()
        {
            ...
            营销退货明细单 form = new 营销退货明细单(Convert.ToInt32(dgv_Show.CurrentRow.Cells["ID"].Value), m_authFlag);
            form.ShowDialog();
        ...
        private void 营销退货_Resize(object sender, EventArgs e)
        {
