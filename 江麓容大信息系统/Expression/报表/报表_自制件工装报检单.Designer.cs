namespace Expression
{
    partial class 报表_自制件工装报检单
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "DepotManagementDataSet_View_S_FrockInDepotBill";
            reportDataSource2.Name = "DepotManagementDataSet_View_S_FrockInDepotGoodsBill";
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Expression.报表.报表_自制件工装报检单.rdlc";
            ...
            this.Name = "报表_自制件工装报检单";
            this.Text = "普通入库单";
            this.Load += new System.EventHandler(this.报表_自制件工装报检单_Load);
