...
{
    public partial class 报表_营销业务单据 : Form, IBillReportInfo
    {
        string m_billID = "";
        ...
        public 报表_营销业务单据(string billID, string billName)
        {
            InitializeComponent();
            m_billID = billID;
            m_billName = billName;
        ...
        private void InitData()
        {
            ...
            ReportParameter rp2 = new ReportParameter("JYRY", this.DepotManagementDataSet.View_S_MarketingAll[0].Table.Rows[0]["JYRY"].ToString());
        ...
        private void 报表_营销入库单_Load(object sender, EventArgs e)
        {
