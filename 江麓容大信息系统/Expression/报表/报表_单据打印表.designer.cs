namespace Expression
{
    partial class 报表_单据打印表
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "DepotManagementDataSet_View_S_ScrapBill";
            reportDataSource1.Value = null;
            reportDataSource2.Name = "DepotManagementDataSet_View_S_ScrapGoods";
            reportDataSource2.Value = null;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Expression.报表.报表_单据打印表.rdlc";
