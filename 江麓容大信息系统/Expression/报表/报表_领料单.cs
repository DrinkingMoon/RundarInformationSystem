...
namespace Expression
{
    ...
    /// 领料报表界面
    /// </summary>
    public partial class 报表_领料单 : Form, IBillReportInfo
    {
        string m_billID = "";
        ...
        public 报表_领料单(string billID, string billName)
        {
            InitializeComponent();
        ...
        private void InitData()
        {
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                string sql = "select * from DepotManagement.dbo.View_S_MaterialRequisitionGoods where "+
                             " 领料单号='" + m_billID + "' order by 显示位置";
        ...
        private void FormReportFetchGoodsBill_Load(object sender, EventArgs e)
        {
