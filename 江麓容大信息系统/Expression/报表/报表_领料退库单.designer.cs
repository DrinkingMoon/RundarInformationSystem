namespace Expression
{
    partial class 报表_领料退库单
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "DepotManagementDataSet_View_S_MaterialReturnedInTheDepot";
            reportDataSource2.Name = "DepotManagementDataSet_View_S_MaterialListReturnedInTheDepot";
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Expression.报表.报表_领料退库单.rdlc";
