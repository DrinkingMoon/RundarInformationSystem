namespace Expression
{
    partial class 报表_自制件入库单
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "DepotManagementDataSet_View_S_HomemadePartBill";
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Expression.报表.报表_自制件入库单.rdlc";
