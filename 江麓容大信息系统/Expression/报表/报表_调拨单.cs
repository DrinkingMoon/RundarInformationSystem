...
{
    public partial class 报表_调拨单 : Form, IBillReportInfo
    {
        string m_billID = "";
        ...
        public 报表_调拨单(string billID, string billName)
        {
            InitializeComponent();
            m_billID = billID;
            m_billName = billName;
        ...
        private void InitData()
        {
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                string sql = "select * from DepotManagement.dbo.View_S_Cannibalize where DJH = '" + m_billID + "'";
                SqlCommand command = new SqlCommand(sql);
                command.Connection = conn;

                SqlDataAdapter adapter = new SqlDataAdapter(command);
                adapter.Fill(this.DepotManagementDataSet.View_S_Cannibalize);

                ReportDataSource rds = new ReportDataSource("DepotManagementDataSet_View_S_Cannibalize", 
                    this.DepotManagementDataSet.View_S_Cannibalize);
        ...
        private void 报表_调拨单_Load(object sender, EventArgs e)
        {
