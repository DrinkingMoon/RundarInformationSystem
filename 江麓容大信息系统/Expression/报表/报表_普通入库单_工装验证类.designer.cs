namespace Expression
{
    partial class 报表_普通入库单_工装验证类
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Expression.报表.报表_普通入库单_工装验证类.rdlc";
            ...
            this.Name = "报表_普通入库单_工装验证类";
            this.Text = "普通入库单_工装验证";
