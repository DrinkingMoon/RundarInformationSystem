namespace Expression
{
    partial class 报表_自制件退货单
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "DepotManagementDataSet_View_S_HomemadeRejectBill";
            reportDataSource2.Name = "DepotManagementDataSet_View_S_HomemadeRejectList";
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Expression.报表.报表_自制件退货单.rdlc";
            ...
            this.Name = "报表_自制件退货单";
            this.Text = "报表_自制件退货单";
            this.Load += new System.EventHandler(this.报表_自制件退货单_Load);
